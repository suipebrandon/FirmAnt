          ...
          <div className="relative mx-auto grid min-h-[calc(100vh-72px)] max-w-7xl content-center px-4 py-16 lg:px-8">
            <div className="max-w-3xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Button href="#contact">{t.quote as string} <ArrowRight size={18} /></Button>
        ...
        <section className="bg-white py-5">
          <div className="mx-auto grid max-w-7xl gap-3 px-4 sm:grid-cols-2 lg:grid-cols-4 lg:px-8">
            {(t.trust as string[]).map((item) => (
              <div key={item} className="flex items-center gap-2 rounded-md bg-blush px-4 py-3 text-sm font-bold text-ink">
        ...
        <Section id="services" eyebrow="Services" title="Complete construction, design and finishing support">
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {services.map((service) => (
              <article key={service.title} className="rounded-lg border border-ink/10 bg-white p-5 shadow-soft">
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-4 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...
                <div key={title} className="rounded-lg border border-white/10 bg-white/7 p-5">
        ...
        <Section id="resources" eyebrow="Resources" title="Guides that help clients avoid costly mistakes">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {resources.map((resource) => (
              <article key={resource} className="rounded-lg border border-ink/10 bg-white p-5 shadow-soft">
            ...
            <div>
              ...
              <div className="mt-8 grid gap-4">
                {testimonials.map((testimonial) => (
                  <blockquote key={testimonial.name} className="rounded-lg bg-white p-5 shadow-soft">
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-4 lg:grid-cols-[0.85fr_1.15fr] lg:px-8">
            <div>
              ...
              <div className="mt-6 grid gap-4 text-ink/72">
                <p className="flex gap-3"><MapPinned className="shrink-0 text-brand" /> {contact.address}</p>
