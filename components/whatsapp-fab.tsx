...
export function WhatsAppFab() {
  return (
    <motion.a
      ...
      className="focus-ring fixed bottom-24 right-6 z-50 inline-flex size-12 items-center justify-center rounded-full bg-brand text-white shadow-soft transition hover:bg-ember"
